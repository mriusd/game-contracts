...
//     RarityMultiplierPct   int
//     LevelMultiplierPct    int
//     AddPointsMultiplierPct int
//     LuckMultiplierPct     int
//     ExceMultiplierPct     int

//     BuySellMultiplier     int
// }

// var ShopPriceList PriceList;

// func CalculateItemSellingPrice(item *items.TokenAttributes) int {
//     var basePrice int
...
//     rarityMultiplier := 1 + (ShopPriceList.RarityMultiplierPct*item.ItemAttributes.ItemRarityLevel.int())/100
//     levelMultiplier := 1 + (ShopPriceList.LevelMultiplierPct*item.ItemLevel.int())/100
//     optionMultiplier := 1 + (ShopPriceList.AddPointsMultiplierPct*(item.AdditionalDamage.int()+item.AdditionalDefense.int())/4)/100
//     luckMultiplier := int(1)
//     if item.Luck {
//         luckMultiplier = 1 + (ShopPriceList.LuckMultiplierPct)/100
//     }
//     excellentMultiplier := int(1)
